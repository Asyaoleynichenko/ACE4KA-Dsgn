...
**Все страницы проектов (макеты):** [фрейм 89-156](https://www.figma.com/design/3p1Mnu6yIL6Y8CwebsdP1F/%D0%92-%D1%80%D0%B0%D0%B7%D1%80%D0%B0%D0%B1%D0%BE%D1%82%D0%BA%D1%83?node-id=89-156&m=dev) — сверка вёрстки с `ProjectDetailPage`, `layout: case-study` и данными в `src/data/projects.js` (порядок карточек и соседей в кейсе: константа `CASE_STUDY_DISPLAY_ORDER` в `projects.js`).
...
| **[300:104226](https://www.figma.com/design/3p1Mnu6yIL6Y8CwebsdP1F/%D0%92-%D1%80%D0%B0%D0%B7%D1%80%D0%B0%D0%B1%D0%BE%D1%82%D0%BA%D1%83?node-id=300-104226&m=dev)** | `ProjectDetailPage` — Mail Наука и редизайн медиа (`slug: mail-nauki`, `layout: 'case-study'`) | Hero (карусель мокапов), заголовок + мета, 2×2, секции с гипотезами, модульная система, запуск MVP, масштабирование, dual-outcomes; данные в `projects.js`, порядок в ленте — `CASE_STUDY_DISPLAY_ORDER`. |
...
| **[300:106258](https://www.figma.com/design/3p1Mnu6yIL6Y8CwebsdP1F/%D0%92-%D1%80%D0%B0%D0%B7%D1%80%D0%B0%D0%B1%D0%BE%D1%82%D0%BA%D1%83?node-id=300-106258&m=dev)** | `ProjectDetailPage` — лендинг о нейросетях Mail Hi-Tech (`slug: neural`) | Интерактивный спецпроект: hero, мета, 2×2, пилюли «В рамках проекта», секции решения и AI-driven production; ассеты `public/images/figma-sync-20260205-neural-*`. |
...
| **[376:587](https://www.figma.com/design/3p1Mnu6yIL6Y8CwebsdP1F/%D0%92-%D1%80%D0%B0%D0%B7%D1%80%D0%B0%D0%B1%D0%BE%D1%82%D0%BA%D1%83?node-id=376-587&m=dev)** | `ProjectDetailPage` — RackTables / Yandex Fast Track (`slug: racktables`, `layout: 'case-study'`) | Кейс: hero, Vibe-coding, проблема Objects, медиа-блок, решение, результат; ассеты `public/images/figma-sync-racktables-376587/`. |
...
- **Project detail 1-522**: hero 1310×721, radius 21px; top row title+lead | meta card 415px #0f0f0f 16px 24px; grid 2 cols gap 24px; cards #0f0f0f 16px 33px; footer border-top 65px, 2 cols gap 48px; tools pills 12px #262626 border. (Отдельная ссылка «к проектам» в теле страницы не используется — навигация через шапку и футер.)
