...
function MacTrafficLights() {
  return (
    <div className="preview-card-block__traffic" aria-hidden="true">
      <span className="preview-card-block__traffic-dot preview-card-block__traffic-dot--close" title="Закрыть" />
      <span className="preview-card-block__traffic-dot preview-card-block__traffic-dot--minimize" title="Свернуть" />
      <span className="preview-card-block__traffic-dot preview-card-block__traffic-dot--zoom" title="Развернуть" />
    </div>
  );
}
...
export default function PreviewCardBlock() {
  ...
  return (
    <a
      ...
      aria-label="Написать мне в Telegram, @pnkprty"
    >
